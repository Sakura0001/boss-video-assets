...
3. `boss greet` 后必须立刻补充一条真人化消息：“我看了下你的背景，和我们数据库/软件研发方向还挺匹配的，所以想单独跟你沟通一下，不是单纯群发。方便的话我给你简单介绍下我们这边方向。”这是必须环节，用来避免候选人以为是广撒网自动发送。
4. 真人化补充消息之后，按顺序补充 3-4 条岗位信息，每条单独发送，不要合并成长段落。
